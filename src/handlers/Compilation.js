        ...
        try {
            ...
            switch(areaType) {
                case 'province':
                    ...
                    let provinceReports = await ProvinceReportModel.find(query).populate([
                ...
                case 'country':
                    ...
                    let markazReports = await MarkazReportModel.find(query).populate([
                ...
                case 'division':
                    ...
                    let divReprots = await DivisionReportModel.find(query).populate([
                      { path: "maqamTanzeemId" },
                      { path: "wiId" },
                ...
                case 'ilaqa':
                    ...
                    let ilaqaReports = await IlaqaReportModel.find(query).populate([
                      { path: "maqamTanzeemId" },
                      { path: "wiId" },
                      { path: "maqamActivityId" },
                      { path: "mentionedActivityId" },
                ...
                case 'halqa':
                    ...
                    let halqaReports = await HalqaReportModel.find(query).populate([
                      { path: "wiId" },
